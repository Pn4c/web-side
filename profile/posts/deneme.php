<div class="panel-group" id="panel-group">
	<div class="panel panel-default" style="border:0px;">
		...
		<div class="panel-body" style="padding:0px 0px 0px 0px;color:rgba(0,0,0,1);background-color: rgba(129,80,187,0.5);"><div style="background:rgba(255,255,255,0.5);"><?php echo $each_data['Content']; ?></div></div>
