<div class="panel-group" id="panel-group">
	<div class="panel panel-default" style="background-size: 100% 100%; background-image:url('../../static/images/dead.jpg');border:0px;">
		...
		<div class="panel-body" style="padding:3% 0px 3% 20%;color:rgba(0,0,0);background-color: rgba(71,71,65,0.5);"><div style="box-shadow:0px 0px 50px #FFFFFF;background:rgba(255,255,255,0.5); border-radius:8px;padding:5% 5% 5% 5%;margin:0px 5% 0px 0px;"><?php echo $each_data['Content']; ?></div></div>
