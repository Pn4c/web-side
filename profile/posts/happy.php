<div class="panel-group" id="panel-group">
	<div class="panel panel-default" style="background-position: center;background-image:url('../../static/images/happy.jpg');border:0px;">
		...
		<div class="panel-body" style="padding:3% 0px 3% 20%;color:rgba(0,0,0);background-color: rgba(250,255,82,0.5);"><div style="box-shadow:0px 0px 50px #FFFFFF;background:rgba(255,255,255,0.5); border-radius:8px;padding:5% 5% 5% 5%;margin:0px 5% 0px 0px;"><?php echo $each_data['Content']; ?></div></div>
